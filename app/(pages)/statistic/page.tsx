...
import { Home, TrendingUp, PlusCircle, Wallet, Settings, ShoppingBasket, Laptop, Gamepad, Plus } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm">
            ...
            <div className="text-4xl font-bold mb-1">{currencySymbols[currency as 'EUR' | 'KZT' | 'USD']}3,000</div>
            <div className="text-green-500 text-sm mb-8">+500 compared to last month</div>
            ...
            <div className="relative h-48">
              ...
              <div className="flex justify-between text-xs text-gray-400 mt-2">
                <span>{currencySymbols[currency as 'EUR' | 'KZT' | 'USD']}5,000</span>
                <span>2</span>
                <span>80</span>
                <span>6</span>
                <span>8</span>
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="relative w-48 h-48">
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                  ...
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#1f2937" strokeWidth="20" strokeDasharray="25.12 251.2" strokeDashoffset="0" />
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#9ca3af" strokeWidth="20" strokeDasharray="50.24 251.2" strokeDashoffset="-25.12" />
                  <circle cx="50" cy="50" r="40" fill="none" stroke="#d1d5db" strokeWidth="20" strokeDasharray="50.24 251.2" strokeDashoffset="-75.36" />
                </svg>
              ...
              >
                ...
                <div className="text-right">
                  <div className="font-bold">
                    {currencySymbols[currency as 'EUR' | 'KZT' | 'USD']}{Math.abs(transaction.amount).toFixed(1)}
                  </div>
